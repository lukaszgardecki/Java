...
public class RecipeDao {
    ...
    Optional<Recipe> findByTitle(String searchTitle) {
        final String sql = String.format("SELECT id, title, description, ingredients, preptime FROM recipe WHERE title = '%s'",
                searchTitle);
    ...
    boolean delete(int id) {
        final String sql = String.format("DELETE FROM recipe WHERE id = %s", id);
