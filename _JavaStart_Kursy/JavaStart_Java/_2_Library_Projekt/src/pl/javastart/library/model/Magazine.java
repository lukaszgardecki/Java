...
public class Magazine extends Publication {
    ...
    public String toString() {
        return super.toString() + String.format(", %s; %s; %s", monthDay.getMonthValue(), monthDay.getDayOfMonth(), language);
    }

    @Override
    public String toCsv() {
        return String.format("%s;%s;%s;%s;%d;%d;%s",
                TYPE, getTitle(), getPublisher(), getYear(), monthDay.getMonthValue(), monthDay.getDayOfMonth(), language);
    }
