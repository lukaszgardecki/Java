...
public class Zad20RelacjaManyToManyApplication {

    public static void main(String[] args) {
        ConfigurableApplicationContext context = SpringApplication.run(Zad20RelacjaManyToManyApplication.class, args);
