...
import com.example.Spring_Boot_Kurs1.controller.dto.PostDto;
import com.example.Spring_Boot_Kurs1.model.Post;
import com.example.Spring_Boot_Kurs1.service.PostService;
...
public class PostController {
    ...
    @GetMapping("/posts")
    public List<PostDto> getPosts(@RequestParam(required = false) Integer page, Sort.Direction sort, @AuthenticationPrincipal String user) {
