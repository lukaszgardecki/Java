...
import wzorce.fabryka.składniki.sos.SosMeksykański;
import wzorce.fabryka.składniki.warzywa.*;

public class MaksykańskaFabrykaSkładnikówPizzy implements FabrykaSkładnikówPizzy {
    @Override
