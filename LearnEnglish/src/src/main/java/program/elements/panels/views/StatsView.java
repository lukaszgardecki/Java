...
public class StatsView extends View {
    ...
    public static JLabel t1, t2, t3, t4, t5, t6, t7, t8, t9, t10;

    public StatsView() {
        setLocation(80, 30);
        setSize(TEXTCOL_WIDTH+VALUECOL_WIDTH, 320);
        setLayout(null);
...
//        ----------  ROW 6 ----------
        ...
        //        ----------  ROW 7 ----------
        JLabel s7 = new JLabel("Iloœæ nauczonych s³ówek: ");
        s7.setBounds(LEFT_MARGIN, UP_MARGIN + 7 * VERTICAL_GAP, TEXTCOL_WIDTH, ROW_HEIGHT);
        s7.setFont(plainFont);
        add(s7);

        t7 = new JLabel(String.valueOf(Main.map.get(6).size()));
        t7.setBounds(TEXTCOL_WIDTH, UP_MARGIN + 7 * VERTICAL_GAP, VALUECOL_WIDTH, ROW_HEIGHT);
        t7.setFont(boldFont);
        add(t7);

//        ----------  ROW 8 ----------
        JLabel s8 = new JLabel("Iloœæ poprawnych odpowiedzi: ");
        s8.setBounds(LEFT_MARGIN, UP_MARGIN + 9 * VERTICAL_GAP, TEXTCOL_WIDTH, ROW_HEIGHT);
        s8.setFont(plainFont);
        add(s8);

        t8 = new JLabel(Main.getAmountOfCorrectAns());
        t8.setBounds(TEXTCOL_WIDTH, UP_MARGIN + 9 * VERTICAL_GAP, VALUECOL_WIDTH, ROW_HEIGHT);
        t8.setFont(boldFont);
        add(t8);

//        ----------  ROW 9 ----------
        JLabel s9 = new JLabel("Iloœæ niepoprawnych odpowiedzi: ");
        s9.setBounds(LEFT_MARGIN, UP_MARGIN + 10 * VERTICAL_GAP, TEXTCOL_WIDTH, ROW_HEIGHT);
        s9.setFont(plainFont);
        add(s9);

        t9 = new JLabel(Main.getAmountOfIncorrectAns());
        t9.setBounds(TEXTCOL_WIDTH, UP_MARGIN + 10 * VERTICAL_GAP, VALUECOL_WIDTH, ROW_HEIGHT);
        t9.setFont(boldFont);
        add(t9);

//        ----------  ROW 10 ----------
        JLabel s10 = new JLabel("Iloœæ wszystkich odpowiedzi: ");
        s10.setBounds(LEFT_MARGIN, UP_MARGIN + 11 * VERTICAL_GAP, TEXTCOL_WIDTH, ROW_HEIGHT);
        s10.setFont(plainFont);
        add(s10);

        t10 = new JLabel(Main.getAmountOfAllAns());
        t10.setBounds(TEXTCOL_WIDTH, UP_MARGIN + 11 * VERTICAL_GAP, VALUECOL_WIDTH, ROW_HEIGHT);
        t10.setFont(boldFont);
        add(t10);
