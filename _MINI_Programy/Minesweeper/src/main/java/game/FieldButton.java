...
public class FieldButton extends JButton {
    ...
    static ImageIcon flag = new ImageIcon("src/main/java/game/images/flag.png");
    ImageIcon questionMark = new ImageIcon("src/main/java/game/images/question-mark.png");
    static ImageIcon xSign = new ImageIcon("src/main/java/game/images/x.png");
